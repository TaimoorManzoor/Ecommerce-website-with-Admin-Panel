  ...
  <div class="w3-row-padding w3-margin-bottom">
    ...
    <form action="add_user.php" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="email" class="form-control" required="" name="email" id="Email" placeholder="Enter Last Name">
      </div>

      <div class="form-group">
        <label for="Phone">Phone:<span style='color:red'>*</span></label>
        <input type="text" class="form-control" required="" name="phone" id="Phone" placeholder="Enter Last Name">
      </div>
